...
# 1. 参数设置
src_dir = r"C:\Users\xrVis001\Desktop\EyeData\IXI-400-LPI\50seg"
output_dir = os.path.join(src_dir, "haimaprocessed_binary")
...
for fname in os.listdir(src_dir):
    ...
    try:
        ...
        binary_data = np.where((data == 14) | (data == 30), 1, 0).astype(np.uint8)
